...
INSERT INTO `user_accounts` (`recordSeq`, `username`, `ownerId`, `acctPassword`, `firstName`, `lastName`, `greetingName`, `orgName`, `email`, `accountType`, `wluxUrlRoot`, `clientUrlRoot`, `defaultTimeZone`, `dateCreated`, `dateModified`) VALUES
(1, 'defaultAdmin', 0, '1Password', 'Default', 'Admin', 'Admin', 'IBUXL Research', 'ibuxl@example.com', 'admin', 'http://wlux.uw.edu/', 'http://wlux.uw.edu', 'UTC−08 America/Los_Angeles', '2014-01-06 20:26:49', '2014-01-07 04:26:49'),
(2, 'defaultResearcher', 0, '1Password', 'Default', 'Researcher', 'Researcher', 'IBUXL Research', 'ibuxl@example.com', 'researcher', 'http://wlux.uw.edu/', 'http://wlux.uw.edu/', 'UTC−08 America/Los_Angeles', '2014-01-06 20:26:49', '2014-01-07 04:26:49');
