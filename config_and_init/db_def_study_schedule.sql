...
CREATE TABLE IF NOT EXISTS study_schedule (
  ...
  sessionName varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  sessionDescription longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  sessionParticipantLimit bigint(20) NOT NULL DEFAULT '-1',
  sessionStartTime datetime NOT NULL DEFAULT 0,
  sessionEndTime datetime NOT NULL DEFAULT 0,
  sessionAnnouncementText longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  sessionEmailList longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
